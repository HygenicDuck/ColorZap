...
namespace AssetBundles
{
	...
	{
		const string kLocalAssetbundleServerMenu = "Kwalee/AssetBundles/Local AssetBundle Server";
...
//		}
		...
		static void Run ()
		{
			...
			string args = Path.Combine (pathToApp, "Assets/StreamingAssets");
			...
			startInfo.WorkingDirectory = Path.Combine(System.Environment.CurrentDirectory, "Assets/StreamingAssets");
